...
|---|---|---|---|
| `quick` (default) | 500 | 15s | Sanity check — direct and proxy LLM paths |
...
| `mixed` | 500 total | 60s | Direct + proxy LLM paths (parallel) |
| `endurance` | 500 | 30 min | Long-running stability, goroutine leaks |
| `realistic` | 50 | 2 min | SSE streaming with 30-50ms inter-token delay |
