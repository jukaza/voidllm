  ...
  return (
    <div className="flex items-center gap-3 rounded-xl border border-white/5 bg-bg-primary/60 px-4 py-3">
      ...
      <div className="min-w-0">
        <div className="text-lg font-semibold tabular-nums text-text-primary">{loading ? '...' : value}</div>
  ...
  return (
    <>
      <div className="space-y-6">
        ...
        {isAdmin && pendingTopupCount > 0 && (
          <Link to="/finance/topups?status=pending" className="block no-underline">
            <Banner variant="info" title={t('dashboard.pending_topups', { count: pendingTopupCount })} />
          </Link>
        )}
        ...
        <div className="relative overflow-hidden rounded-2xl border border-accent/15 bg-bg-secondary">
          ...
          <div className="relative p-6 lg:p-8">
            <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
              <div>
                <p className="text-xs font-medium uppercase tracking-wider text-accent">{t('dashboard.period_24h')}</p>
              ...
              <div className="flex flex-wrap gap-2 lg:justify-end">
                ...
                <HeroLinkButton to="/keys">{t('dashboard.action_keys')}</HeroLinkButton>
                {lowBalance && <HeroLinkButton to="/wallet">{t('dashboard.hero_cta_topup')}</HeroLinkButton>}
              </div>
            </div>
      ...
      {updateInfo != null && (
        ...
        >
          <p className="mb-4 text-xs text-text-tertiary">You are running {updateInfo.current_version}</p>
